...
class Day14 : PuzzleReader, TimeSaver {
    ...
    private val input = readLines("2021/input14.txt")

    override fun solve1(): Any = if (fullSolve) delta(countPolymer(nextPolymer(rootPolymer))) else growLarge(10)

    override fun solve2(): Any = growLarge()
